      ...
      <form @submit.prevent="saveUser">
        <div class="space-y-4">
          <template v-if="editingUser">
            <FormTextField v-model="editingUser.name" label="Name" required />

            <FormTextField v-model="editingUser.email" label="Email" type="email" required />

            <FormCheckbox v-model="editingUser.isSuperuser" label="Admin User" />
          </template>

          <template v-else>
            <FormTextField v-model="newUser.name" label="Name" required />

            <FormTextField v-model="newUser.email" label="Email" type="email" required />
            ...
            <FormCheckbox v-model="newUser.isSuperuser" label="Admin User" />
          </template>

          <div class="flex justify-end space-x-2 pt-4">
            <BaseButton type="button" variant="outline" @click="userDialog = false"> Cancel </BaseButton>
            <BaseButton type="submit" :disabled="!editingUser && !passwordScore.isValid">
      ...
      <BaseCard>
        ...
        <div class="p-4">
          ...
          <p class="mb-4 text-sm text-gray-600">
            Create, edit, and delete users. Only admin users can access this page.
          </p>
